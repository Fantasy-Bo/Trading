...
def render_report(
    ...
    with col_md:
        ...
        st.download_button(
            ...
            file_name=f"TradingAgents-波波个股分析_{_safe_filename_label(ticker_label)}_{trade_date}.md",
            mime="text/markdown",
    ...
    with col_pdf:
        try:
            ...
            st.download_button(
                "📄 下载 PDF",
                data=pdf_bytes,
                file_name=f"TradingAgents-波波个股分析_{_safe_filename_label(ticker_label)}_{trade_date}.pdf",
